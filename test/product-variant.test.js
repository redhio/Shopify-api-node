describe('Redhio#productVariant', () => {
  'use strict';
  ...
  it('gets a list of all product variants for a product (1/2)', () => {
    ...
    return redhio.productVariant.list(632910392)
  ...
  it('gets a list of all product variants for a product (2/2)', () => {
    ...
    return redhio.productVariant.list(632910392, { since_id: 39072855 })
      .then(data => expect(data).to.deep.equal(output.variants));
  });
  ...
  it('gets a count of all product variants', () => {
    ...
    return redhio.productVariant.count(632910392)
  ...
  it('gets a single product variant by its ID (1/2)', () => {
    ...
    return redhio.productVariant.get(808950810)
  ...
  it('gets a single product variant by its ID (2/2)', () => {
    ...
    return redhio.productVariant.get(808950810, { foo: 'bar' })
      .then(data => expect(data).to.deep.equal(output.variant));
  });
  ...
  it('creates a new product variant', () => {
    ...
    return redhio.productVariant.create(632910392, input.variant)
      .then(data => expect(data).to.deep.equal(output.variant));
  });
  ...
  it('updates a product variant', () => {
    ...
    return redhio.productVariant.update(808950810, input.variant)
      .then(data => expect(data).to.deep.equal(output.variant));
  });
  ...
  it('deletes a product variant', () => {
    ...
    return redhio.productVariant.delete(632910392, 808950810)
